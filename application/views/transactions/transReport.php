        ...
        <div class="container margin-top-5">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $get->ref ?></td>
                                        <td><?= $get->quantity ?></td>
                                        <td>PKR <?= number_format($get->totalMoneySpent, 2) ?></td>
                                        <td>PKR <?= number_format($get->amountTendered, 2) ?></td>
                                        <td>PKR <?= number_format($get->changeDue, 2) ?></td>
            ...
            <div class="row" style="margin-bottom: 10px">
                ...
                <div class="col-xs-6 text-right">
                    <h4>Total Earned: PKR <?=number_format($total_earned, 2)?></h4>
                </div>
            </div>
        </div>
        <!--- panel end-->
